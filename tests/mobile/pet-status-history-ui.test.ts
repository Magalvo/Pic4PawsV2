...
} from '../../apps/mobile/src/pet-status-history';
import type {
  MobilePetStatusHistoryUiContent,
} from '../../apps/mobile/src/pet-status-history';
...
describe('mobilePetStatusHistoryUiContent', () => {
  it('has locale pt-PT and product-flow-ready status', () => {
    const content: MobilePetStatusHistoryUiContent = mobilePetStatusHistoryUiContent;
    expect(content.locale).toBe('pt-PT');
    expect(content.status).toBe('product-flow-ready');
  });

  it('has title, description, and loadingMessage', () => {
    expect(typeof mobilePetStatusHistoryUiContent.title).toBe('string');
    expect(typeof mobilePetStatusHistoryUiContent.description).toBe('string');
    expect(typeof mobilePetStatusHistoryUiContent.loadingMessage).toBe('string');
  });
});

// ─── Initial state ────────────────────────────────────────────────────────────

describe('createMobilePetStatusHistoryUi — initial state', () => {
  it('returns idle state', () => {
    const ui = createMobilePetStatusHistoryUi({
...
describe('createMobilePetStatusHistoryUi — loading state', () => {
...
describe('createMobilePetStatusHistoryUi — success', () => {
...
describe('createMobilePetStatusHistoryUi — forbidden', () => {
...
describe('createMobilePetStatusHistoryUi — failed', () => {
