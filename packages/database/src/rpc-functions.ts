...
revoke execute on function register_shelter(uuid, text, text, text, text, text, text, text, text, text, uuid, uuid) from public, anon, authenticated;
grant execute on function register_shelter(uuid, text, text, text, text, text, text, text, text, text, uuid, uuid) to service_role;
`;
