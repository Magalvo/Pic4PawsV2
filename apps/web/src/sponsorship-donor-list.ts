...
export type WebSponsorshipDonorListUiContent = {
  locale: 'pt-PT';
...
export const webSponsorshipDonorListUiContent: WebSponsorshipDonorListUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type WebSponsorshipDonorListIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type WebSponsorshipDonorListLoadingState = {
  state: 'loading';
  title: string;
  message: string;
};

export type WebSponsorshipDonorListLoadedState = {
  state: 'loaded';
  title: string;
  message: string;
...
export type WebSponsorshipDonorListEmptyState = {
  state: 'empty';
  title: string;
  message: string;
};

export type WebSponsorshipDonorListFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type WebSponsorshipDonorListResultViewModel =
  | WebSponsorshipDonorListIdleState
  | WebSponsorshipDonorListLoadingState
  | WebSponsorshipDonorListLoadedState
  | WebSponsorshipDonorListEmptyState
  | WebSponsorshipDonorListFailedState;
...
export const createWebSponsorshipDonorListUi = ({
  sponsorshipDonorListClient,
}: {
  sponsorshipDonorListClient: Pick<SponsorshipDonorListClient, 'loadDonorSponsorships'>;
}) => ({
  getInitialState: (): WebSponsorshipDonorListIdleState => ({
    state: 'idle',
    title: 'Os meus apadrinhamentos',
    message: 'Carrega para ver os teus apadrinhamentos.',
