...
export type WebUserRegistrationUiContent = {
  locale: 'pt-PT';
...
export const webUserRegistrationUiContent: WebUserRegistrationUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
  title: 'Criar conta',
...
export type WebUserRegistrationIdleState = {
  state: 'idle';
  title: string;
};

export type WebUserRegistrationRegisteredState = {
  state: 'registered';
  title: string;
  message: string;
};

export type WebUserRegistrationFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type WebUserRegistrationState =
...
export const createWebUserRegistrationUi = ({
  userRegistrationClient,
}: {
  ...
  ): Promise<WebUserRegistrationRegisteredState | WebUserRegistrationFailedState> => {
