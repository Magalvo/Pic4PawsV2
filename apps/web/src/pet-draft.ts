...
export type WebPetDraftLoadedState = {
  state: 'loaded';
  draft: LoadPetDraftClientDraft;
};

export type WebPetDraftLoadNotFoundState = {
  state: 'not_found';
  title: string;
  message: string;
};

export type WebPetDraftLoadForbiddenState = {
  state: 'forbidden';
  title: string;
  message: string;
};

export type WebPetDraftLoadFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type WebPetDraftLoadViewModel =
