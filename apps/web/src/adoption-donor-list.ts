...
export type WebAdoptionDonorListUiContent = {
  locale: 'pt-PT';
...
export const webAdoptionDonorListUiContent: WebAdoptionDonorListUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type WebAdoptionDonorListIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type WebAdoptionDonorListLoadingState = {
  state: 'loading';
  title: string;
  message: string;
};

export type WebAdoptionDonorListLoadedState = {
  state: 'loaded';
  title: string;
  message: string;
...
export type WebAdoptionDonorListEmptyState = {
  state: 'empty';
  title: string;
  message: string;
};

export type WebAdoptionDonorListFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type WebAdoptionDonorListResultViewModel =
  | WebAdoptionDonorListIdleState
  | WebAdoptionDonorListLoadingState
  | WebAdoptionDonorListLoadedState
  | WebAdoptionDonorListEmptyState
  | WebAdoptionDonorListFailedState;
...
export const createWebAdoptionDonorListUi = ({
  adoptionDonorListClient,
}: {
  adoptionDonorListClient: Pick<AdoptionDonorListClient, 'loadDonorAdoptions'>;
}) => ({
  getInitialState: (): WebAdoptionDonorListIdleState => ({
    state: 'idle',
    title: 'Os meus pedidos de adoção',
    message: 'Carrega para ver os teus pedidos de adoção.',
