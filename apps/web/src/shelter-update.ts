...
export type WebShelterUpdateUiContent = {
  locale: 'pt-PT';
...
export const webShelterUpdateUiContent: WebShelterUpdateUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
  title: 'Editar abrigo',
...
export type WebShelterUpdateIdleState = {
  state: 'idle';
  title: string;
};

export type WebShelterUpdateSubmittingState = {
  state: 'submitting';
  title: string;
};

export type WebShelterUpdateUpdatedState = {
  state: 'updated';
  title: string;
  message: string;
  shelterId: string;
...
export type WebShelterUpdateFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type WebShelterUpdateState =
  | WebShelterUpdateIdleState
  | WebShelterUpdateSubmittingState
  | WebShelterUpdateUpdatedState
  | WebShelterUpdateFailedState;
...
export const createWebShelterUpdateUi = ({
  shelterUpdateClient,
}: {
  shelterUpdateClient: Pick<ShelterUpdateClient, 'updateShelter'>;
}) => ({
  getInitialState: (): WebShelterUpdateIdleState => ({
    state: 'idle',
    title: 'Editar abrigo',
  }),
  ...
  ): Promise<WebShelterUpdateUpdatedState | WebShelterUpdateFailedState> => {
