...
export default function GuardarDraftScreen() {
  ...
  const handleSave = useCallback(async () => {
    ...
    let newFiles: PetDraftSaveFlowFileInput[] | undefined;
    ...
    const saveFlowUi = createMobilePetDraftSaveFlowUi({ saveFlowClient: makeSaveFlowClient(getAccessToken) });
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.field}>
          <Text style={styles.label}>Nova imagem (URI, opcional)</Text>
          <TextInput
            style={styles.input}
            value={fileUri}
