...
import { mobileShelterSearchUiContent, type MobileShelterSearchUiContent } from './shelter-search';
import {
  mobileNotificationPreferencesUiContent,
  type MobileNotificationPreferencesUiContent,
...
import {
  ...
  type MobileShelterPetListUiContent,
} from './shelter-pet-list';
import {
  mobileShelterRegistrationUiContent,
  type MobileShelterRegistrationUiContent,
...
export const mobileFoundationContent: MobileFoundationContent = {
  ...
  shelterSearch: {
    title: mobileShelterSearchUiContent.title,
    description: mobileShelterSearchUiContent.description,
    status: mobileShelterSearchUiContent.status,
  },
  notificationPreferences: {
    title: mobileNotificationPreferencesUiContent.title,
    description: mobileNotificationPreferencesUiContent.description,
    status: mobileNotificationPreferencesUiContent.status,
  },
  financialsDashboard: {
  ...
  shelterPetList: {
    title: mobileShelterPetListUiContent.title,
    description: mobileShelterPetListUiContent.description,
    status: mobileShelterPetListUiContent.status,
  },
  shelterRegistration: {
    title: mobileShelterRegistrationUiContent.title,
    description: mobileShelterRegistrationUiContent.description,
    status: mobileShelterRegistrationUiContent.status,
  },
  shelterUpdate: {
