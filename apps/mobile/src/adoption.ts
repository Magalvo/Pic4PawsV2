...
export type MobileAdoptionUiContent = {
  locale: 'pt-PT';
...
export const mobileAdoptionUiContent: MobileAdoptionUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileAdoptionIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type MobileAdoptionSubmittingState = {
  state: 'submitting';
  title: string;
  message: string;
};

export type MobileAdoptionSubmittedState = {
  state: 'submitted';
  title: string;
  message: string;
...
export type MobileAdoptionPetNotFoundState = {
  state: 'pet_not_found';
  title: string;
  message: string;
};

export type MobileAdoptionFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type MobileAdoptionResultViewModel =
  | MobileAdoptionIdleState
  | MobileAdoptionSubmittingState
  | MobileAdoptionSubmittedState
  | MobileAdoptionPetNotFoundState
  | MobileAdoptionFailedState;
...
export const createMobileAdoptionUi = ({
  adoptionApplicationClient,
}: {
  adoptionApplicationClient: Pick<AdoptionApplicationClient, 'submitApplication'>;
}) => ({
  getInitialState: (): MobileAdoptionIdleState => ({
    state: 'idle',
    title: 'Candidatura à adoção',
    message: 'Preenche o formulário para te candidatares à adoção.',
  ...
  submitApplication: async (
    ...
    MobileAdoptionSubmittedState | MobileAdoptionPetNotFoundState | MobileAdoptionFailedState
  > => {
