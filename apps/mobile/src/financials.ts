...
export type MobileFinancialsDashboardUiContent = {
  locale: 'pt-PT';
...
export const mobileFinancialsDashboardUiContent: MobileFinancialsDashboardUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileFinancialsDashboardIdleState = {
  state: 'idle';
};

export type MobileFinancialsDashboardLoadingState = {
  state: 'loading';
};

export type MobileFinancialsDashboardLoadedState = {
  state: 'loaded';
  summary: FinancialsClientSummary;
};

export type MobileFinancialsDashboardForbiddenState = {
  state: 'forbidden';
  message: string;
};

export type MobileFinancialsDashboardFailedState = {
  state: 'failed';
...
export type MobileFinancialsDashboardState =
  | MobileFinancialsDashboardIdleState
  | MobileFinancialsDashboardLoadingState
  | MobileFinancialsDashboardLoadedState
  | MobileFinancialsDashboardForbiddenState
  | MobileFinancialsDashboardFailedState;
...
export const createMobileFinancialsDashboardUi = ({
  financialsClient,
}: {
  financialsClient: Pick<FinancialsClient, 'loadFinancials'>;
}) => ({
  getInitialState: (): MobileFinancialsDashboardIdleState => ({ state: 'idle' }),
