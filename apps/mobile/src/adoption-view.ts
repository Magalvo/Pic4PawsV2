...
export type MobileAdoptionViewUiContent = {
  locale: 'pt-PT';
...
export const mobileAdoptionViewUiContent: MobileAdoptionViewUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileAdoptionViewIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type MobileAdoptionViewLoadingState = {
  state: 'loading';
  title: string;
  message: string;
};

export type MobileAdoptionViewLoadedState = {
  state: 'loaded';
  title: string;
  message: string;
...
export type MobileAdoptionViewNotFoundState = {
  state: 'not_found';
  title: string;
  message: string;
};

export type MobileAdoptionViewForbiddenState = {
  state: 'forbidden';
  title: string;
  message: string;
};

export type MobileAdoptionViewFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type MobileAdoptionViewResultViewModel =
  | MobileAdoptionViewIdleState
  | MobileAdoptionViewLoadingState
  | MobileAdoptionViewLoadedState
  | MobileAdoptionViewNotFoundState
  | MobileAdoptionViewForbiddenState
  | MobileAdoptionViewFailedState;
...
export const createMobileAdoptionViewUi = ({
  adoptionViewClient,
}: {
  adoptionViewClient: Pick<AdoptionViewClient, 'loadAdoptionView'>;
}) => ({
  getInitialState: (): MobileAdoptionViewIdleState => ({
    state: 'idle',
    title: 'Estado da candidatura',
    message: 'Consulta o estado da tua candidatura de adoção.',
