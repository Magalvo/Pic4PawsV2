...
export type MobileShelterPetListUiContent = {
  locale: 'pt-PT';
...
export const mobileShelterPetListUiContent: MobileShelterPetListUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileShelterPetListIdleState = {
  state: 'idle';
  title: string;
  message: string;
};

export type MobileShelterPetListLoadedState = {
  state: 'loaded';
  title: string;
...
export type MobileShelterPetListEmptyState = {
  state: 'empty';
  title: string;
  message: string;
  query: ShelterPetListQuery;
...
export type MobileShelterPetListForbiddenState = {
  state: 'forbidden';
  message: string;
};

export type MobileShelterPetListFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type MobileShelterPetListResultViewModel =
  | MobileShelterPetListLoadedState
  | MobileShelterPetListEmptyState
  | MobileShelterPetListForbiddenState
  | MobileShelterPetListFailedState;
...
export const createMobileShelterPetListUi = ({
  shelterPetListClient,
}: {
  shelterPetListClient: Pick<ShelterPetListClient, 'loadShelterPets'>;
}) => ({
  getInitialState: (): MobileShelterPetListIdleState => ({
    state: 'idle',
    title: 'Animais do abrigo',
    message: 'Carrega a lista de animais para começar a gerir.',
  }),
  ...
  loadShelterPets: async (
    shelterId: string,
    query: ShelterPetListQuery = {},
  ): Promise<MobileShelterPetListResultViewModel> => {
