...
export type MobileShelterSearchUiContent = {
  locale: 'pt-PT';
...
export const mobileShelterSearchUiContent: MobileShelterSearchUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileShelterSearchIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type MobileShelterSearchLoadedState = {
  state: 'loaded';
  title: string;
...
export type MobileShelterSearchEmptyState = {
  state: 'empty';
  title: string;
  message: string;
  query: ShelterSearchClientQuery;
...
export type MobileShelterSearchFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type MobileShelterSearchResultViewModel =
  | MobileShelterSearchLoadedState
  | MobileShelterSearchEmptyState
  | MobileShelterSearchFailedState;
...
export const createMobileShelterSearchUi = ({
  shelterSearchClient,
}: {
  shelterSearchClient: Pick<ShelterSearchClient, 'searchShelters'>;
}) => ({
  getInitialState: (): MobileShelterSearchIdleState => ({
    state: 'idle',
    title: 'Pesquisar abrigos',
    message: 'Descobre os abrigos verificados disponíveis.',
  ...
  searchShelters: async (
    query: ShelterSearchClientQuery,
  ): Promise<MobileShelterSearchResultViewModel> => {
