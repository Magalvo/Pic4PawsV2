...
export type MobilePetDraftSaveFlowUiState = 'ready' | 'saving' | 'saved' | 'failed';

export type MobilePetDraftSaveFlowUiStateCopy = {
  state: MobilePetDraftSaveFlowUiState;
  title: string;
  message: string;
};

export type MobilePetDraftSaveFlowUiContent = {
  locale: 'pt-PT';
  title: string;
  description: string;
  status: 'product-flow-ready';
  states: MobilePetDraftSaveFlowUiStateCopy[];
};

export type MobilePetDraftSaveFlowContext = {
  petName?: string | null;
};

export type MobilePetDraftSaveFlowReadyViewModel = {
  state: 'ready';
  title: string;
  message: string;
...
export type MobilePetDraftSaveFlowResultViewModel =
  | {
      state: 'saved';
      title: string;
      message: string;
...
export type CreateMobilePetDraftSaveFlowUiInput = {
  saveFlowClient: Pick<PetDraftSaveFlowClient, 'savePetDraft'>;
};

export type MobilePetDraftSaveFlowUi = {
  getInitialState: (context: MobilePetDraftSaveFlowContext) => MobilePetDraftSaveFlowReadyViewModel;
  saveDraft: (input: {
    context: MobilePetDraftSaveFlowContext;
    draft: PetDraftSaveFlowInput;
  }) => Promise<MobilePetDraftSaveFlowResultViewModel>;
};
...
export const mobilePetDraftSaveFlowUiContent: MobilePetDraftSaveFlowUiContent = {
  locale: 'pt-PT',
  title: 'Guardar rascunho com imagens',
  description:
    'Fluxo mobile para criar ou atualizar rascunhos de animais com imagens novas através do fluxo seguro.',
  status: 'product-flow-ready',
  states: [
    {
      state: 'ready',
...
export const createMobilePetDraftSaveFlowUi = ({
  saveFlowClient,
}: CreateMobilePetDraftSaveFlowUiInput): MobilePetDraftSaveFlowUi => ({
