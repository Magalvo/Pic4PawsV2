...
export type MobileDonationListUiContent = {
  locale: 'pt-PT';
...
export const mobileDonationListUiContent: MobileDonationListUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileDonationListIdleState = {
  state: 'idle';
  title: string;
  message: string;
...
export type MobileDonationListLoadingState = {
  state: 'loading';
  title: string;
  message: string;
};

export type MobileDonationListLoadedState = {
  state: 'loaded';
  title: string;
  message: string;
...
export type MobileDonationListEmptyState = {
  state: 'empty';
  title: string;
  message: string;
};

export type MobileDonationListForbiddenState = {
  state: 'forbidden';
  title: string;
  message: string;
};

export type MobileDonationListFailedState = {
  state: 'failed';
  title: string;
  message: string;
...
export type MobileDonationListResultViewModel =
  | MobileDonationListIdleState
  | MobileDonationListLoadingState
  | MobileDonationListLoadedState
  | MobileDonationListEmptyState
  | MobileDonationListForbiddenState
  | MobileDonationListFailedState;
...
export const createMobileDonationListUi = ({
  donationListClient,
}: {
  donationListClient: Pick<DonationListClient, 'loadDonations'>;
}) => ({
  getInitialState: (): MobileDonationListIdleState => ({
    state: 'idle',
    title: 'Donativos recebidos',
    message: 'Consulta os donativos recebidos para este abrigo.',
