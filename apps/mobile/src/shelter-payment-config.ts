...
export type MobileShelterPaymentConfigUiContent = {
  locale: 'pt-PT';
...
export const mobileShelterPaymentConfigUiContent: MobileShelterPaymentConfigUiContent = {
  locale: 'pt-PT',
  status: 'product-flow-ready',
...
export type MobileShelterPaymentConfigIdleState = {
  state: 'idle';
  title: string;
  iban: string | null;
...
export type MobileShelterPaymentConfigSavingState = {
  state: 'saving';
  title: string;
};

export type MobileShelterPaymentConfigSavedState = {
  state: 'saved';
  title: string;
  message: string;
};

export type MobileShelterPaymentConfigFailureStatus =
  | ShelterPaymentConfigClientFailureStatus
  | LoadPaymentConfigClientFailureStatus;

export type MobileShelterPaymentConfigFailedState = {
  state: 'failed';
  title: string;
  message: string;
  status: MobileShelterPaymentConfigFailureStatus;
  reasons: string[];
  canRetry: true;
};

export type MobileShelterPaymentConfigForbiddenState = {
  state: 'forbidden';
  title: string;
  message: string;
};

export type MobileShelterPaymentConfigViewModel =
  | MobileShelterPaymentConfigIdleState
  | MobileShelterPaymentConfigSavingState
  | MobileShelterPaymentConfigSavedState
  | MobileShelterPaymentConfigFailedState
  | MobileShelterPaymentConfigForbiddenState;
...
export const createMobileShelterPaymentConfigUi = ({
  saveConfigClient,
  loadConfigClient,
}: {
