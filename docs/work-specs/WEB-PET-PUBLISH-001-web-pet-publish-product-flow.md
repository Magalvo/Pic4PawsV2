# Work-Spec: Implementation Plan for WEB-PET-PUBLISH-001

## 1. Target Files

- `docs/work-items/WEB-PET-PUBLISH-001-web-pet-publish-product-flow.md`
- `docs/work-specs/WEB-PET-PUBLISH-001-web-pet-publish-product-flow.md`
- `apps/web/src/pet-publish.ts`
- `apps/web/src/foundation.ts`
- `tests/web/pet-publish-ui.test.ts`
- `docs/work-tracks/remake-foundation.md`
- `docs/codex-resume.md`

## 2. Proposed Technical Approach

Add `createWebPetPublishUi` with an injected dependency:
...
- Add Web product tests with a fake injected publish client.
...
- Assert Web foundation content exposes the publish product flow.
...
- Web foundation content now exposes `petPublish`.
